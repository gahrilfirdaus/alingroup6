...
st.write("""
This app demonstrates matrix-based geometric transformations:
- Translation  
- Scaling  
- Rotation  
- Shearing  
...
def reflection_matrix(axis, center=(0,0)):
    mats = {
        "x": np.array([[1,0,0],[0,-1,0],[0,0,1]],float),
...
tool = st.sidebar.selectbox("Choose transformation", ["Translation","Scaling","Rotation","Shearing","Reflection"])
